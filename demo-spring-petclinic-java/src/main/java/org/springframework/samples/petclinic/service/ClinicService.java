...
public interface ClinicService {
    ...
    List<Appointment> findAppointmentsByPetId(Integer petId) throws DataAccessException;
    List<Appointment> findAppointmentsByVetId(Integer vetId) throws DataAccessException;
    List<Appointment> findAppointmentsByDate(LocalDate date) throws DataAccessException;
    List<Appointment> findAppointmentsByVetIdAndDate(Integer vetId, LocalDate date) throws DataAccessException;
